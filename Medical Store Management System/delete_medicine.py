...
def password_not_recognised():
    ...
    Label(password_not_recog_screen, text='Medicine does not Exist',font='garamond',bg='#000000',fg='white').pack()
...
def login_success_book(pas):
    ...
    login_success_screen.title('Medicine Deleted')
    ...
    Label(login_success_screen, text='Medicine Deleted Successfully', font='Garamond',fg='white',bg='#000000').pack()
...
def main_page():
    ...
    main_screen.title('Delete Medicines')
    ...
    Label(bg='#000000').pack()
    Button(text='Enter',width=20, height=1, font='Times', fg='white', bg='#d90166',borderwidth=3,command=login_verify_med).pack()
